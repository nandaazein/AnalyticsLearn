...
const LoginGuru = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 bg-gray-100">
      <div className="flex flex-col items-center w-full max-w-md sm:max-w-lg md:max-w-3xl p-6 sm:p-8 bg-white shadow-md rounded-2xl md:flex-row">
        {/* Gambar di sisi kiri - Diimpor dari src/assets */}
        <div className="w-full mb-4 sm:mb-6 md:w-1/2 md:mb-0 md:pr-6">
          <img
            src={loginImage}
            alt="Ilustrasi Login Guru"
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label className="block mb-1 text-sm sm:text-base text-gray-700">NIP</label>
              <input
                type="text"
                value={nip}
                onChange={(e) => setNip(e.target.value)}
            ...
            <div>
              <label className="block mb-1 text-sm sm:text-base text-gray-700">Kata Sandi</label>
              <input
                type="password"
                value={password}
                onChange={(e) => setPassword(e.target.value)}
            ...
            <button
              type="submit"
              className="w-full py-2 text-sm sm:text-base text-white bg-green-700 rounded-lg cursor-pointer hover:bg-green-800 transition duration-300"
            >
              Masuk
            </button>
          </form>
