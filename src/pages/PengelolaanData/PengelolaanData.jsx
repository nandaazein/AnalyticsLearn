  ...
  return (
    <Layout>
      ...
      <div className="bg-white p-5 border border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
          <li className="text-justify">
            <strong>Abaikan kolom yang tidak diperlukan</strong> → Misalnya kolom Alamat tidak perlu ditampilkanan.
          </li>
          <li className="text-justify">
            <strong>Tampilkan hanya kolom yang relevan yang</strong> → Seperti Nama, Nilai, dan Kelas.
          </li>
          <li className="text-justify">
        ...
        <div className="bg-[#F5F5F5] p-2 sm:p-3 md:p-4 border border-[#B0BEC5] rounded mt-4 sm:mt-6 shadow-md">
          ...
          <p className="text-gray-700 text-xs sm:text-sm md:text-base text-justify mb-2">
            Kamu ingin menyaring siswa dari kelas 8A dari tabel yang berisi nama, kelas, nilai, dan alamat. Pilih kolom yang diperlukan:
          </p>
      ...
      <div className="bg-white p-5 border border-gray-300 space-y-4 mt-10 relative">
        ...
        <div className="bg-[#F5F5F5] p-2 sm:p-3 md:p-4 border border-[#B0BEC5] rounded mt-4 sm:mt-6 shadow-md">
          ...
          {algoritmaFeedback && (
            <p
              className={`text-xs sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg font-bold ${
                algoritmaFeedback?.includes("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
              }`}
            >
              {algoritmaFeedback}
            </p>
      ...
      <div className="bg-white p-5 border border-gray-300 space-y-4 mt-12">
        <div className="flex items-center justify-between px-2 py-2 bg-gray-100 border-b border-gray-300 rounded-t-lg sm:px-4 md:px-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg">Kuis Pemahaman: Pengelolaan Data</h3>
            ...
            <div className="mt-4 flex justify-between">
              <div className="flex space-x-2">
                <button
                  ...
                  className="bg-[#B0BEC5] text-white px-3 sm:px-4 py-1 sm:py-2 rounded hover:bg-[#90A4AE] transition duration-300 cursor-pointer disabled:opacity-50 text-xs sm:text-sm md:text-base"
      ...
      {/* Tombol Navigasi */}
      <div className="flex justify-between mt-8 px-2 sm:px-4">
        <button
