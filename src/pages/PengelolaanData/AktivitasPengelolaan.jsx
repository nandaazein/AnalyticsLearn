...
const AktivitasPengelolaan = () => {
  ...
  const renderLangkahSeret = (items) => {
    const filteredItems = items.filter(
      (item) => !langkahDisusun.includes(item)
    );
        ...
        <div className="p-2 sm:p-6 bg-white">
          ...
          <section className="p-2 sm:p-4 bg-green-100 rounded shadow-md mb-2 sm:mb-6">
            ...
            <ol className="list-decimal list-inside text-gray-700 space-y-1 text-xs sm:text-sm md:text-base">
              <li>
                ...
                pemahaman Anda mengenai pengelolaan data.
              </li>
              <li>
          ...
          <div className="p-2 sm:p-6 mb-2 sm:mb-6 bg-green-50 border border-green-200 rounded-lg shadow-md">
            <p className="px-2 sm:px-4 mb-2 sm:mb-4 text-xs sm:text-sm md:text-base leading-relaxed text-gray-700 flex items-center">
              ...
              Seret dan susun langkah-langkah berikut agar benar untuk
              mengurutkan nilai siswa dari tertinggi ke terendah:
            </p>
            <div className="px-2 sm:px-4">
              <div className="mb-2 sm:mb-4">
                {renderLangkahSeret(daftarLangkah)}
              </div>
              <div
          ...
          <div className="p-2 sm:p-6 mb-2 sm:mb-6 bg-green-50 border border-green-200 rounded-lg shadow-md">
            <p className="px-2 sm:px-4 mb-2 sm:mb-4 text-xs sm:text-sm md:text-base leading-relaxed text-gray-700 flex items-center">
              ...
              sedangkan filtering digunakan untuk ... data yang tidak memenuhi
              syarat tertentu.
            </p>
          ...
          <div className="p-2 sm:p-6 mb-2 sm:mb-6 bg-green-50 border border-green-200 rounded-lg shadow-md">
            <p className="px-2 sm:px-4 mb-2 sm:mb-4 text-xs sm:text-sm md:text-base leading-relaxed text-gray-700 flex items-center">
              ...
              Seorang guru ingin mengetahui siswa dengan nilai tertinggi. Ia
          ...
          <div className="p-2 sm:p-6 mb-2 sm:mb-6 bg-green-50 border border-green-200 rounded-lg shadow-md">
            <p className="px-2 sm:px-4 mb-2 sm:mb-4 text-xs sm:text-sm md:text-base leading-relaxed text-gray-700 flex items-center">
              ...
              Seorang manajer toko ingin menampilkan hanya produk dengan
              kategori "Elektronik". Ia harus menggunakan fitur ...
            </p>
            <div className="flex flex-col sm:flex-row items-center px-2 sm:px-4 mb-2 sm:mb-4 space-y-2 sm:space-y-0 sm:space-x-2">
              <label className="text-gray-700 text-xs sm:text-sm md:text-base font-medium">
                Jawaban:
              ...
              <label className="flex items-center text-xs sm:text-sm md:text-base text-gray-700">
                <input
                  ...
                  onChange={() =>
                    setJawabanSoal5({
                      ...jawabanSoal5,
                      menghapus: !jawabanSoal5.menghapus,
                    })
                  }
                  className="mr-2"
                />
              ...
              <label className="flex items-center text-xs sm:text-sm md:text-base text-gray-700">
                <input
                  ...
                  onChange={() =>
                    setJawabanSoal5({
                      ...jawabanSoal5,
                      menyaring: !jawabanSoal5.menyaring,
                    })
                  }
                  className="mr-2"
                />
              ...
              <label className="flex items-center text-xs sm:text-sm md:text-base text-gray-700">
                <input
                  ...
                  onChange={() =>
                    setJawabanSoal5({
                      ...jawabanSoal5,
                      menerapkan: !jawabanSoal5.menerapkan,
                    })
                  }
                  className="mr-2"
                />
              ...
              <label className="flex items-center text-xs sm:text-sm md:text-base text-gray-700">
                <input
                  ...
                  onChange={() =>
                    setJawabanSoal5({
                      ...jawabanSoal5,
                      mengubah: !jawabanSoal5.mengubah,
                    })
                  }
                  className="mr-2"
                />
