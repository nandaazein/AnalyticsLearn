  ...
  return (
    <>
      ...
      <div className="homepage flex flex-col min-h-screen pb-10 text-[#214C1E]">
        <div className="flex-grow max-w-6xl px-8 mx-auto text-center bg-gray-100">
          <h1 className="text-3xl font-bold my-8 text-[#1D6F35]">
            MEDIA PEMBELAJARAN ANALISIS DATA
          </h1>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="p-6 mx-auto bg-white border border-gray-300 rounded-lg shadow-lg box w-80">
              <img
                src={informasi}
                alt="Daftar Isi"
