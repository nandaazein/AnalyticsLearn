...
const Pendahuluan = () => {
  ...
  const checkAnswers = () => {
    const correctAnswers = [
      "Membandingkan nilai ulangan dengan teman",
    ...
    setFeedback(
      isCorrect
        ? "Benar! Kamu sudah melakukan analisis data dalam kegiatan sehari-hari."
        : "Salah. Pilih aktivitas yang berhubungan dengan analisis data. Coba lagi!"
    );
  };
  ...
  return (
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        {/* Paragraf Pengantar */}
        <div className="bg-gray-100 p-4 mt-4 border border-gray-300">
          <p className="text-gray-700 leading-relaxed text-justify">
            Di kelas VII, kalian telah belajar dasar-dasar pengolahan data.
            Sekarang, coba bayangkan saat mencari nama teman di daftar panjang
            atau tugas lama di tumpukan file. Akan lebih mudah jika data bisa
            diurutkan atau difilter sesuai kebutuhan, bukan?
          </p>
          <p className="mt-2 text-gray-700 leading-relaxed text-justify">
            Di kelas VIII ini, kalian akan mendalami{" "}
            <strong>pencarian data</strong>, <strong>peringkasan data</strong>,
            <strong> visualisasi data</strong>, dan{" "}
            <strong>pengelolaan data</strong> (sorting & filtering) untuk
            mengolah informasi lebih efisien. Dengan keterampilan ini, kalian
            dapat mengelola data secara sistematis dan membuat keputusan lebih
            baik.
          </p>
        </div>
        ...
        <div className="bg-white p-4 shadow-md rounded mt-4 border border-gray-300">
          <h2 className="font-bold text-lg flex items-center text-[#255F38]">
            <i className="ri-lightbulb-line text-[#255F38] text-xl mr-2"></i>{" "}
            Tahukah Kamu?
          </h2>
          ...
          <p className="text-center text-sm italic text-gray-500 mt-2">
            Gambar 1. Mengelola Data sebagai Siswa
          </p>

          {/* Paragraf Informasi */}
          <p className="mt-4 text-gray-700 leading-relaxed text-justify">
            Sebagai siswa, kalian tentu pernah mengalami situasi seperti mencari
            nilai ulangan tertentu, menyusun jadwal piket kelas, atau memeriksa
            siapa saja yang belum mengumpulkan tugas. Semua kegiatan tersebut
            melibatkan data dan memerlukan keterampilan untuk mengelolanya
            dengan baik.
          </p>

          <p className="mt-2 text-gray-700 leading-relaxed text-justify">
            Dengan bantuan fitur <strong>pencarian data</strong>, kalian dapat
            menemukan informasi yang dibutuhkan dengan lebih cepat, seperti
            mengetahui siapa yang memperoleh nilai tertinggi dalam suatu mata
            pelajaran. Fitur <strong>filter</strong> juga memudahkan dalam
            menyaring data, misalnya hanya menampilkan siswa yang belum
            mengumpulkan tugas.
          </p>

          <p className="mt-2 text-gray-700 leading-relaxed text-justify">
            Selain itu, kalian dapat membuat <strong>peringkasan data</strong>{" "}
            menggunakan fungsi seperti
            <strong> SUMIF</strong> atau <strong>COUNTIF</strong>, contohnya
            untuk menghitung jumlah tugas yang telah dikumpulkan setiap minggu.
            Dengan <strong>visualisasi data</strong> seperti grafik batang,
            kalian juga dapat melihat perkembangan nilai dari waktu ke waktu
            secara lebih jelas.
          </p>

          <p className="mt-2 text-gray-700 leading-relaxed text-justify">
            Melalui kegiatan tersebut, kalian sebenarnya telah menerapkan
            prinsip <strong> analisis data </strong>
            dalam kehidupan sehari-hari. Kemampuan ini sangat berguna untuk
            memahami informasi, mengambil keputusan, serta menjadi lebih teratur
            dan sistematis dalam belajar maupun beraktivitas di sekolah.
          </p>
          ...
          <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-1 sm:mt-2 relative">
            <div className="bg-[#F0FFF4] p-3 sm:p-4 border border-[#81C784] rounded mt-4 shadow-md">
              ...
              <p className="text-gray-700 text-sm md:text-base mt-1 sm:mt-2 text-justify">
                Sebelum belajar lebih dalam tentang analisis data, mari kita
                ingat pengalamanmu. Sebagai siswa, kamu pasti pernah melakukan
                kegiatan yang melibatkan analisis data, seperti membandingkan
                nilai atau menghitung sesuatu untuk membuat keputusan. Coba
                pikirkan kegiatan berikut yang pernah kamu lakukan:
              </p>
              <p className="text-gray-700 text-sm md:text-base text-justify mb-2">
                Pilih kegiatan yang pernah kamu lakukan yang berhubungan dengan
                analisis data:
              </p>
              <div className="ml-4 sm:ml-6 text-gray-700 space-y-1 sm:space-y-2">
                <div className="text-sm md:text-base">
