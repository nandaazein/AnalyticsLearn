    ...
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        <section className="bg-green-100 rounded shadow-md p-4 mt-4 border border-gray-300">
          ...
          <p className="text-sm md:text-base text-gray-700 text-justify leading-relaxed">
            Peserta didik mampu memahami konsep dasar analisis data dan
            pentingnya dalam kehidupan sehari-hari.
          </p>
        </section>

        {/* Introduction */}
        <div className="bg-white p-5 border-gray-300 mt-4 space-y-4 rounded-lg shadow-md border border-gray-300">
          <h2 className="text-xl font-bold text-green-800 flex items-center">
            <Lightbulb className="w-5 h-5 mr-2" /> Apa Itu Analisis Data?
          </h2>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed text-justify">
            Analisis data adalah proses mengolah dan memahami informasi dalam
            bentuk angka, teks, atau kategori tertentu untuk menemukan pola,
        ...
        <div className="bg-white p-5 border-gray-300 mt-4 space-y-4 rounded-lg shadow-md border border-gray-300">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed text-justify">
            Analisis data membantu kita membuat keputusan cerdas, seperti
            memilih camilan favorit berdasarkan suara teman atau menentukan
            waktu terbaik untuk belajar. Ini dia beberapa kelebihannya:
          </p>
          <ul className="list-disc ml-8 space-y-2 text-sm md:text-base text-gray-700">
            <li>Membantu memilih keputusan terbaik.</li>
            <li>Menemukan pola, seperti nilai ujian yang terus naik.</li>
            <li>
              Menyelesaikan masalah dengan cepat, seperti mencari tahu mengapa
              timmu kalah dalam lomba.
            </li>
          </ul>
        </div>

        {/* Interactive Quiz */}
        <div className="bg-green-100 p-4 border-l-4 border-green-800 rounded-lg shadow-md mt-4 space-y-3 border border-gray-300">
          <h3 className="text-green-800 font-bold flex items-center">
            <Search className="w-5 h-5 mr-2" /> Mengapa Analisis Data Penting?
          </h3>
          <p className="text-sm md:text-base text-gray-700">
        ...
        <div className="bg-white p-5 border-gray-300 mt-4 space-y-4 rounded-lg shadow-md border border-gray-300">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed text-justify">
            Analisis data dilakukan dengan beberapa langkah utama yang sesuai
            dengan materi yang akan dipelajari dalam bab ini:
          </p>
          <ul className="list-disc ml-8 space-y-2 text-sm md:text-base text-gray-700">
            <li>
              ...
              lebih efisien. Misalnya, mencari nilai seorang siswa dalam daftar
            ...
            <li>
              ...
              Contohnya, menyajikan nilai rata-rata kelas dalam bentuk diagram
              batang.
            </li>
            <li>
              <span className="font-semibold">
              ...
              seperti menghitung jumlah siswa yang mendapatkan nilai di atas
              KKM.
            </li>
            <li>
              <span className="font-semibold">
        ...
        <div className="bg-white p-5 border-gray-300 mt-4 space-y-4 rounded-lg shadow-md border border-gray-300">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed text-justify">
            Dalam bab ini, kalian akan belajar bagaimana menerapkan analisis
