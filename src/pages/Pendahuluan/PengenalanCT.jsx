...
const PengenalanCT = () => {
  ...
  const cekJawaban = () => {
    if (totalBelanja === "8000") {
      ...
      setFeedback(
        "Jawaban salah, ayo coba lagi. Jumlahkan harga pensil (Rp2.000), buku (Rp5.000), dan penghapus (Rp1.000)."
      );
    }
  };
  ...
  const handleDrop = (e, dropIndex) => {
    ...
    const newDekomposisiItems = dekomposisiItems.filter(
  ...
  const checkDekomposisiAnswers = () => {
    ...
    const isCorrect = dropZoneItems.every(
  ...
  const handleAlgorithmDrop = (e, dropIndex) => {
    ...
    const newAlgorithmItems = algorithmItems.filter(
      (_, i) => i !== parseInt(dragIndex)
    );
    setAlgorithmItems(newAlgorithmItems);
  };
  ...
  const checkAlgorithmAnswers = () => {
    ...
    const isCorrect = algorithmDropZone.every(
      (item, index) => item === correctOrder[index]
    );
    setAlgorithmFeedback(
      isCorrect
  ...
  return (
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        {/* Tujuan Pembelajaran */}
        <section className="bg-green-100 rounded shadow-md p-4 mt-4 border border-gray-300">
          <h2 className="font-bold text-[#255F38] flex items-center">
            Tujuan Pembelajaran
          </h2>
          <p className="text-gray-700 text-sm md:text-base">
            Peserta didik mampu memahami konsep dasar Computational Thinking
            (CT) dan menerapkannya dalam menyelesaikan masalah sederhana melalui
            studi kasus.
          </p>
        </section>

        {/* Pengenalan Computational Thinking */}
        <div className="bg-white p-5 border-gray-300 mt-4 space-y-4 border border-gray-300">
          <h2 className="text-2xl font-bold text-green-800 mb-2">
            Apa Itu Computational Thinking?
          </h2>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed text-justify">
            <span className="font-bold">Computational Thinking (CT)</span>{" "}
            adalah cara berpikir untuk memecahkan masalah dengan langkah-langkah
            yang jelas dan sederhana, seperti yang dilakukan komputer. CT
            membantu kita menyelesaikan masalah sehari-hari, seperti berbelanja
            atau mengatur waktu.
          </p>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed text-justify">
            CT terdiri dari empat langkah: <b>Dekomposisi</b>,{" "}
            <b>Pengenalan Pola</b>, <b>Abstraksi</b>, dan <b>Algoritma</b>. Mari
            kita coba terapkan pada studi kasus berikut.
          </p>
        </div>

        {/* Studi Kasus */}
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-5 border border-gray-300">
          <h2 className="text-xl font-bold text-green-800 flex items-center">
            <BookOpen className="w-5 h-5 mr-2" /> Studi Kasus
          </h2>
          <p className="text-gray-700 text-sm md:text-base text-justify leading-relaxed">
            Mari kita gunakan Computational Thinking untuk membantu Rina
            berbelanja dengan cerdas.
          </p>
          <p className="text-gray-600 text-sm md:text-base text-justify">
            Rina ingin membeli 3 barang: <b>pensil</b>, <b>buku</b>, dan{" "}
            <b>penghapus</b>. Dia punya uang Rp20.000. Harga barang-barang
            tersebut adalah: pensil Rp2.000, buku Rp5.000, dan penghapus
            Rp1.000. Rina ingin memastikan dia bisa membeli semua barang tanpa
            melebihi anggaran. Bagaimana langkah-langkahnya?
          </p>
          {/* Tabel Sederhana untuk Item */}
          <div className="mt-4 overflow-x-auto text-center">
            <table className="border-collapse border border-green-800 mx-auto max-w-xs sm:max-w-sm md:max-w-md">
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative border border-gray-300">
          ...
          <p className="text-gray-700 text-sm md:text-base text-justify font-semibold mt-4">
            Penjelasan: Dekomposisi adalah memecah masalah besar menjadi
            langkah-langkah kecil yang lebih mudah.
          </p>
          <p className="text-gray-700 text-sm md:text-base text-justify mt-4">
            Rina memecah masalah berbelanja menjadi langkah-langkah sederhana.
            Susun langkah-langkah berikut dengan menyeret ke area yang tepat!
          </p>
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-1/2 bg-gray-100 p-4 rounded-lg">
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative border border-gray-300">
          ...
          <p className="text-gray-700 text-sm md:text-base text-justify font-semibold mt-4">
            Penjelasan: Pengenalan Pola adalah mencari kesamaan atau pola dalam
            data untuk mempermudah penyelesaian.
          </p>
          <p className="text-gray-700 text-sm md:text-base text-justify mt-4">
            Rina melihat harga barang: pensil Rp2.000, buku Rp5.000, penghapus
            Rp1.000. Apa pola yang membantu Rina menghitung total belanja dengan
            mudah?
          </p>
          <div className="bg-[#F0FFF4] p-4 border border-[#81C784] rounded-lg shadow-md space-y-3 mt-4">
            <h3 className="text-[#2E7D32] font-bold text-sm md:text-base">
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative border border-gray-300">
          ...
          <p className="text-gray-700 text-sm md:text-base text-justify font-semibold mt-4">
            Penjelasan: Abstraksi adalah mengabaikan informasi yang tidak
            penting dan fokus pada yang relevan.
          </p>
          <p className="text-gray-700 text-sm md:text-base text-justify mt-4">
            Rina tidak perlu memikirkan warna barang atau lokasi toko. Yang
            penting adalah harga barang dan anggaran. Apa informasi yang paling
            relevan?
          </p>
          <div className="bg-[#F0FFF4] p-4 border border-[#81C784] rounded-lg shadow-md space-y-3 mt-4">
            <h3 className="text-[#2E7D32] font-bold text-sm md:text-base">
            ...
            <p className="text-gray-700 text-sm md:text-base text-justify">
              Pilih informasi yang paling relevan untuk membantu Rina
              berbelanja!
            </p>
            <div className="space-y-2 text-sm md:text-base text-gray-700">
              {[
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative border border-gray-300">
          ...
          <p className="text-gray-700 text-sm md:text-base text-justify font-semibold mt-4">
            Penjelasan: Algoritma adalah langkah-langkah berurutan untuk
            menyelesaikan masalah.
          </p>
          <p className="text-gray-700 text-sm md:text-base text-justify mt-4">
            Rina menyusun langkah-langkah untuk berbelanja. Susun
            langkah-langkah berikut dengan menyeret ke area yang tepat!
          </p>
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-1/2 bg-gray-100 p-4 rounded-lg">
              <h3 className="font-semibold text-green-800 mb-2">
          ...
          {algorithmFeedback && (
            <p
              className={`text-xs font-bold sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg ${
                algorithmFeedback.includes("benar")
                  ? "bg-[#C8E6C9] text-[#1B5E20]"
                  : "bg-[#FFEBEE] text-[#D32F2F]"
              }`}
            >
        ...
        {/* Kesimpulan */}
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 border border-gray-300">
          <h2 className="text-xl font-bold text-green-800 flex items-center">
            <CheckCircle className="w-5 h-5 mr-2" /> Kesimpulan
          </h2>
          <div className="bg-[#F0FFF4] p-4 border border-[#81C784] rounded-lg shadow-md space-y-3">
            ...
            <p className="text-gray-600 text-sm md:text-base text-justify">
              Berapa total harga barang yang dibeli Rina? (Isi dalam rupiah,
              tanpa tanda Rp atau titik, misal: 10000)
            </p>
            <input
              type="text"
              placeholder="Total belanja (misal: 10000)"
          ...
          {feedback ===
            "Jawaban benar! Total belanja Rina adalah Rp8.000, dan ini sesuai dengan anggaran Rp20.000." && (
            <div>
              <p className="text-gray-600 text-sm md:text-base mt-4 font-semibold">
                Kesimpulan:
              </p>
              <ul className="list-disc list-inside text-gray-600 text-sm md:text-base mt-2 space-y-2">
                <li>
                  Dengan CT, Rina bisa berbelanja dengan langkah-langkah yang
                  jelas dan tidak melebihi anggaran.
                </li>
                <li>
                  Memecah masalah, mencari pola, mengabaikan yang tidak penting,
                  dan menyusun langkah-langkah membantu Rina berbelanja dengan
                  efisien.
                </li>
              </ul>
            </div>
