...
//           </div>
//         </div>
//         <div className="bg-[#F0FFF4] p-2 sm:p-4 border border-[#81C784] rounded mt-2 sm:mt-4 shadow-md">
//           <h3 className="text-sm sm:text-lg font-bold text-[#255F38] mb-1 sm:mb-2">MARI MENGAMATI POLA</h3>
//           <p className="text-gray-700 text-sm md:text-base text-justify mb-1 sm:mb-2">
...
//               className="bg-[#1B5E20] text-white px-3 sm:px-4 py-1 sm:py-2 rounded hover:bg-[#145A20] transition duration-300 cursor-pointer text-sm md:text-base"
//             >
//               Periksa
//             </button>
//             <button
//               onClick={resetPattern}
//               className="bg-[#D32F2F] text-white px-3 sm:px-4 py-1 sm:py-2 rounded hover:bg-[#B71C1C] transition duration-300 cursor-pointer text-sm md:text-base"
//             >
//               Hapus
//             </button>
//           </div>
//           {patternFeedback && (
//             <p
//               className={`text-sm md:text-base mt-2 font-bold ${
...
//         <div className="bg-[#F0FFF4] p-2 sm:p-4 border border-[#81C784] rounded mt-2 sm:mt-4 shadow-md">
//           <h3 className="font-semibold text-[#2E7D32] text-sm md:text-base mb-1 sm:mb-2">
...
//             <p
//               className={`text-sm md:text-base mt-2 font-bold ${
//                 abstraksiFeedback.includes("Benar") ? "bg-[#1B5E20] text-white p-1 sm:p-2 rounded" : "text-red-700"
//               }`}
//             >
//               {abstraksiFeedback}
//             </p>
...
//       {/* ALGORITMA */}
//       <div className="bg-white p-2 sm:p-6 border border-gray-200 rounded-lg shadow-md space-y-2 sm:space-y-6 mt-4 sm:mt-8 relative">
//         <div className="absolute -top-3 sm:-top-7 left-2 sm:left-5 bg-green-800 text-white px-2 sm:px-6 py-1 sm:py-2 rounded-t-lg text-sm sm:text-xl font-bold shadow-lg">
//           Algoritma
//         </div>
//         <p className="text-gray-700 text-sm md:text-base mt-4 sm:mt-8 text-justify">
...
//             </p>
//             <ol className="ml-4 sm:ml-8 text-gray-700 text-sm md:text-base list-decimal space-y-1 sm:space-y-2 mt-1 sm:mt-2">
...
//       {/* KUIS PEMAHAMAN */}
//       <div className="bg-white p-2 sm:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-4 sm:mt-12">
//         <h3 className="font-semibold text-[#255F38] text-sm sm:text-lg mb-1 sm:mb-2">Kuis Pemahaman: Pencarian Reference</h3>
...
//         </p>
//         <div className="bg-yellow-50 p-2 sm:p-4 border border-yellow-300 rounded mt-2 sm:mt-4 shadow-md">
...
//               <p
//                 className={`text-sm md:text-base mt-2 font-bold ${
//                   feedback[currentQuestion].includes("Benar") ? "text-[#255F38]" : "text-red-700"
//                 }`}
//               >
//                 {feedback[currentQuestion]}
//               </p>
