...
//         <div className="relative p-2 mt-2 space-y-2 bg-white sm:p-2 md:p-4 sm:mt-4 md:mt-6">
//           <div className="absolute flex items-center px-3 py-1 text-sm font-bold text-white bg-green-800 rounded-t-lg shadow-lg -top-3 sm:-top-3 md:-top-4 left-2 sm:left-2 md:left-4 sm:px-3 md:px-5 sm:py-1 md:py-2 sm:text-base md:text-lg">
//             <Lightbulb className="w-4 h-4 mr-1 sm:mr-1 md:mr-2 sm:w-4 md:w-5 sm:h-4 md:h-5" />{" "}
//             DEKOMPOSISI
//           </div>
...
//         <div className="relative p-2 mt-2 space-y-2 bg-white sm:p-2 md:p-4 sm:mt-4 md:mt-10">
//           <div className="absolute flex items-center px-3 py-1 text-sm font-bold text-white bg-green-800 rounded-t-lg shadow-lg -top-3 sm:-top-3 md:-top-4 left-2 sm:left-2 md:left-4 sm:px-3 md:px-5 sm:py-1 md:py-2 sm:text-base md:text-lg">
//             <BarChart className="w-4 h-4 mr-1 sm:mr-1 md:mr-2 sm:w-4 md:w-5 sm:h-4 md:h-5" />{" "}
//             PENGENALAN POLA
//           </div>
...
//         <div className="relative p-5 mt-10 space-y-4 bg-white sm:p-5 md:p-5">
//           <div className="absolute flex items-center px-5 py-2 text-lg font-bold text-white bg-green-800 rounded-t-lg shadow-lg -top-6 left-4">
//             <Filter className="w-5 h-5 mr-2" /> ABSTRAKSI
//           </div>
//           <p className="mt-6 text-xs text-justify text-gray-600 sm:text-sm md:text-base sm:mt-2 md:mt-2">
  ...
  return (
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        <p className="px-2 text-xs leading-relaxed text-justify text-gray-700 sm:text-sm md:text-base sm:px-2 md:px-6">
          Dalam proses pencarian data, terdapat dua jenis utama fungsi
          pencarian: Lookup dan Reference. Fungsi Lookup digunakan untuk mencari
          nilai tertentu dalam tabel atau array dan mengembalikan hasil yang
          sesuai berdasarkan kunci pencarian. Fungsi ini sering diterapkan dalam
          spreadsheet untuk menemukan data terkait dengan nilai tertentu.
          Sementara itu, fungsi Reference digunakan untuk mengambil nilai
          berdasarkan referensi sel atau alamat memori, sehingga lebih fleksibel
          saat posisi data berubah. Dengan kedua metode ini, pencarian data
        ...
        <div className="px-2 mt-1 ml-4 space-y-1 sm:ml-6 md:ml-6 sm:px-2 md:px-6">
          ...
          <div className="text-xs text-justify sm:text-sm md:text-base">
            <strong>2. Data tidak ditemukan</strong> → Data yang dicari tidak
            ada dalam tabel.
          </div>
        </div>
        ...
        <p className="px-2 mt-2 text-xs leading-relaxed text-justify text-gray-700 sm:text-sm md:text-base sm:px-2 md:px-6 sm:mt-2 md:mt-4">
          Dalam kehidupan sehari-hari, kita sering melakukan pencarian data,
          seperti mencari nomor telepon di kontak ponsel atau informasi barang
          di daftar inventaris. Dalam dunia digital, pencarian data dapat
          dilakukan lebih cepat dan efisien dengan menggunakan fungsi Lookup di
        ...
        <p className="px-2 mt-2 text-xs leading-relaxed text-justify text-gray-700 sm:text-sm md:text-base sm:px-2 md:px-6">
          Pada gambar 2, fungsi <strong>VLOOKUP</strong> digunakan untuk mencari
          sebuah nilai tertentu, misalnya simbol <code>*</code> yang ada di sel
          G5, dalam sebuah tabel di rentang <strong>B5 sampai E9</strong>.
          Fungsi ini akan mencari simbol tersebut di{" "}
          <strong>kolom pertama tabel</strong> (kolom B). Jika simbol{" "}
          <code>*</code> ditemukan, maka fungsi akan mengambil{" "}
          <strong>nilai dari kolom ke-3</strong> (yaitu kolom D) yang sejajar
          atau sebaris dengan simbol tersebut. Angka 3 ini disebut{" "}
          <em>col index num</em>, yaitu posisi kolom yang diambil datanya.
          Karena menggunakan <code>FALSE</code>, artinya hanya akan cocok jika
          simbol yang dicari benar-benar sama persis. Jadi, jika simbol{" "}
          <code>*</code> ada di kolom B, maka nilai yang diambil dari kolom D
          adalah <code>@</code>.
        </p>
        ...
        <p className="px-2 mt-2 text-xs leading-relaxed text-justify text-gray-700 sm:text-sm md:text-base sm:px-2 md:px-6">
          ...
          G5, dalam tabel pada rentang <strong>B5 sampai E9</strong>. Fungsi ini
          akan mencari simbol tersebut di <strong>baris pertama tabel</strong>{" "}
          (yaitu baris 5). Jika simbol <code>*</code> ditemukan, maka fungsi
          akan mengambil <strong>nilai dari baris ke-4</strong> dalam tabel
          (yaitu baris 8), di kolom yang sama. Angka 4 ini disebut{" "}
          <em>row index num</em>, yaitu posisi baris yang datanya ingin diambil.
          Karena kita memakai <code>FALSE</code>, maka pencarian hanya akan
          berhasil jika simbol yang dicari benar-benar sama. Jadi, jika simbol{" "}
          <code>*</code> ditemukan di baris 5, maka nilai dari baris 8 di kolom
          yang sama akan diambil, misalnya <code>@</code>.
        </p>
        ...
        <div className="relative p-2 mt-2 space-y-2 bg-white sm:p-2 md:p-4 sm:mt-4 md:mt-6">
          ...
          <p className="mt-6 text-xs text-justify text-gray-700 sm:text-sm md:text-base sm:mt-3 md:mt-4">
            Sebelum melakukan pencarian dengan fungsi Lookup, kita perlu
            memahami <span className="font-semibold">komponen utama</span> dalam
            pencarian data dan memecahnya menjadi{" "}
            <span className="font-semibold">bagian-bagian kecil</span>.
            Pencarian data dalam tabel lembar kerja dapat dipecah menjadi
          ...
          <ul className="ml-4 space-y-1 text-gray-700 list-disc list-inside sm:ml-4 md:ml-6">
            ...
            <li className="text-xs text-justify sm:text-sm md:text-base">
              <strong>Menentukan jenis</strong> fungsi lookup → Pilih fungsi
              ...
              <div className="mt-1 ml-4 space-y-2 sm:ml-4 md:ml-4">
                <section className="p-2 bg-gray-100 rounded shadow-lg sm:p-2 md:p-4">
                  ...
                  <p className="text-xs text-gray-700 sm:text-sm md:text-base">
                    Fungsi VLOOKUP (Vertical Lookup) dalam spreadsheet digunakan
                    untuk mencari nilai tertentu dalam kolom pertama dari sebuah
                    tabel atau rentang data secara vertical (dari atas ke
                    bawah).
                  </p>
                  <pre className="p-1 overflow-x-auto text-xs text-gray-800 break-words whitespace-normal bg-gray-200 rounded sm:p-1 md:p-2 sm:text-sm md:text-sm">
                    =VLOOKUP(
                  ...
                  <ul className="ml-4 text-gray-700 list-disc list-inside sm:ml-4 md:ml-6">
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>lookup_value:</strong> Nilai yang akan dicari
                      dalam kolom pertama tabel.
                    </li>
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>table_array:</strong> Rentang tabel tempat
                      pencarian dilakukan.
                    </li>
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>col_index_num:</strong> Nomor kolom dari mana
                      nilai yang ingin diambil.
                    </li>
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>range_lookup:</strong>{" "}
                      <span className="italic font-bold">TRUE</span> untuk
                ...
                <section className="p-2 bg-gray-100 rounded shadow-lg sm:p-2 md:p-4">
                  ...
                  <p className="text-xs text-gray-700 sm:text-sm md:text-base">
                    Fungsi HLOOKUP (Horizontal Lookup) dalam spreadsheet
                    digunakan untuk mencari nilai tertentu dalam baris pertama
                    dari sebuah tabel atau rentang data secara horizontal (dari
                    kiri ke kanan).
                  </p>
                  <pre className="p-1 overflow-x-auto text-xs text-gray-800 break-words whitespace-normal bg-gray-200 rounded sm:p-1 md:p-2 sm:text-sm md:text-sm">
                    =HLOOKUP(
                  ...
                  <ul className="ml-4 text-gray-700 list-disc list-inside sm:ml-4 md:ml-6">
                    ...
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>row_index_num:</strong> Nomor baris dari mana
                      nilai yang ingin diambil.
                    </li>
                    <li className="text-xs sm:text-sm md:text-base">
                      <strong>range_lookup:</strong>{" "}
        ...
        <div className="relative p-2 mt-2 space-y-2 bg-white sm:p-2 md:p-4 sm:mt-4 md:mt-10">
          ...
          <div className="ml-4 space-y-1 text-gray-700 sm:ml-4 md:ml-6">
            ...
            <div className="text-xs text-justify sm:text-sm md:text-base">
              <strong>2. Data dalam tabel</strong> referensi harus tersusun
              dengan benar sesuai urutan pencarian.
            </div>
            <div className="text-xs text-justify sm:text-sm md:text-base">
              <strong>3. Pencarian dilakukan</strong> dengan mencocokkan nilai
              referensi dengan baris atau kolom pertama dalam tabel referensi.
        ...
        <div className="relative p-5 mt-10 space-y-4 bg-white sm:p-5 md:p-5">
          ...
          <p className="mt-6 text-xs text-justify text-gray-600 sm:text-sm md:text-base sm:mt-2 md:mt-2">
            Setelah mengidentifikasi pola, kita dapat{" "}
            <span className="font-semibold">menyederhanakan masalah</span>{" "}
            dengan <span className="font-semibold">mengabaikan</span> informasi
            yang tidak perlu dan fokus pada elemen penting untuk pencarian.
          </p>
          <p className="mt-1 text-xs text-justify text-gray-700 sm:text-sm md:text-base">
            📌 Bagian yang harus diperhatikan:
          </p>
        ...
        <div className="relative p-5 mt-10 space-y-4 bg-white sm:p-5 md:p-5">
          ...
          <div className="ml-4 space-y-1 text-gray-700 sm:ml-4 md:ml-6">
            ...
            <div className="text-xs text-justify sm:text-sm md:text-base">
              ...
              <div className="mt-1 ml-4 sm:ml-4 md:ml-4">
                ...
                <div className="text-xs sm:text-sm md:text-base">
                  b. Jika tabel terurut, kita bisa menggunakan TRUE untuk
                  mencari nilai terdekat atau mendekati.
                </div>
              </div>
            </div>
            <div className="text-xs text-justify sm:text-sm md:text-base">
          ...
          <div className="bg-[#F5F5F5] p-2 sm:p-2 md:p-3 border border-[#B0BEC5] rounded mt-2 sm:mt-4 md:mt-4 shadow-md">
            ...
            <p className="mb-2 text-xs text-justify text-gray-700 sm:text-sm md:text-base">
              Perhatikan tabel data yang berisi kolom kode barang dan harga, di
              mana harga untuk kode C002 masih kosong. Gunakan fungsi LOOKUP
              untuk mencari harga C002 pada tabel referensi yang memuat daftar
              kode barang dan harganya, lalu isi harga yang sesuai di tabel
              data.
            </p>
            <div className="flex flex-col justify-center gap-2 mt-2 sm:flex-row sm:gap-4">
              <div className="w-full sm:w-auto">
            ...
            <p className="mt-2 text-xs text-center text-gray-700 sm:text-sm md:text-base">
              <strong>
                {isLookupStarted
                  ? `Langkah ${lookupStep + 1} dari ${lookupSteps.length}: ${
