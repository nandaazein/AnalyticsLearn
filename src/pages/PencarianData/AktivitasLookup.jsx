...
//               className="ml-2 px-3 sm:px-4 py-1 sm:py-2 bg-[#255F38] text-white rounded-lg hover:bg-green-700 transition duration-200 text-xs sm:text-base"
//             >
//               Periksa
//             </button>
//             <button
//               onClick={() => clearInputsAndFeedback(setSelectedFormula, setFormulaFeedback, setIsIndexCorrect)}
//               className="ml-2 px-3 sm:px-4 py-1 sm:py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-200 text-xs sm:text-base"
//             >
//               Hapus
//             </button>
//             {formulaFeedback && (
//               <p className={`text-xs sm:text-sm mt-2 font-bold ${selectedFormula === correctFormula ? "text-green-700" : "text-red-700"}`}>
//                 {formulaFeedback}
//               </p>
//             )}
//           </div>
...
//                 className="px-3 sm:px-4 py-1 sm:py-2 bg-[#255F38] text-white rounded-lg hover:bg-green-700 transition duration-200 text-xs sm:text-base"
//               >
//                 Periksa
//               </button>
//               <button
//                 onClick={() => clearInputsAndFeedback(setStepOrder, setStepFeedback, setIsIndexCorrect)}
//                 className="px-3 sm:px-4 py-1 sm:py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-200 text-xs sm:text-base"
//               >
//                 Hapus
//               </button>
//             </div>
//           </div>
//           {stepFeedback && (
//             <p className={`text-xs sm:text-sm mt-2 font-bold ${stepFeedback.includes("benar") ? "text-green-700" : "text-red-700"}`}>
//               {stepFeedback}
//             </p>
//           )}
//         </div>
...
//                 <tr className="bg-white">
//                   <td className="border p-1 sm:p-2 text-center bg-gray-200 font-bold text-black">2</td>
//                   <th className="border p-1 sm:p-2 text-center font-bold">1</th>
...
//                 <tr className="bg-white">
//                   <td className="border p-1 sm:p-2 text-center bg-gray-200 font-bold text-black">3</td>
//                   <th className="border p-1 sm:p-2 text-center font-bold">2</th>
...
//           </div>
//           {indexFeedback && (
//             <p className={`text-xs sm:text-sm mt-2 font-bold ${isIndexCorrect ? "text-green-700" : "text-red-700"}`}>
//               {indexFeedback}
//             </p>
//           )}
//         </div>
...
//                 <tr className="bg-white">
//                   <td className="border p-1 sm:p-2 text-center bg-gray-200 font-bold text-black">3</td>
//                   <th className="border p-1 sm:p-2 text-center font-bold">3</th>
//                   <td className="border p-1 sm:p-2">Siti</td>
...
//           </div>
//           {matchFeedback && (
//             <p className={`text-xs sm:text-sm mt-2 font-bold ${isMatchCorrect ? "text-green-700" : "text-red-700"}`}>
//               {matchFeedback}
//             </p>
//           )}
//         </div>
...
//           </div>
//           {chooseFeedback && (
//             <p className={`text-xs sm:text-sm mt-2 font-bold ${isChooseCorrect ? "text-green-700" : "text-red-700"}`}>
//               {chooseFeedback}
//             </p>
//           )}
//         </div>
