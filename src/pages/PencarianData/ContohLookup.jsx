...
const ContohLookup = () => {
  return (
    <Layout>
      {/* Header judul */}
      <div className="p-4 bg-[#255F38] text-white font-bold text-lg sm:text-xl text-center rounded-lg shadow-lg">
        CONTOH PENERAPAN FUNGSI LOOKUP
      </div>

      <h2 className="text-lg sm:text-xl md:text-2xl font-bold mt-8 sm:mt-12 mb-4 px-4 text-gray-800">
        Studi Kasus 1: VLOOKUP
      </h2>

      {/* Paragraf Penjelasan VLOOKUP */}
      <p className="text-gray-700 text-sm sm:text-base md:text-lg text-justify leading-relaxed px-4">
        Andi adalah seorang manajer toko yang ingin menentukan kategori diskon untuk pelanggan berdasarkan jumlah pembelian mereka menggunakan spreadsheet. Ia memiliki Tabel 1,
        yang berisi daftar nama pelanggan dan jumlah pembelian mereka (dalam ribuan rupiah). Selain itu, ia juga memiliki Tabel 2, yang berisi rentang jumlah pembelian beserta kategori diskon yang sesuai. Andi ingin mengisi kolom <span className="font-semibold">"Kategori Diskon"</span> pada Tabel 1 secara otomatis dengan menggunakan fungsi <span className="font-semibold">VLOOKUP</span> dengan parameter <span className="font-semibold">TRUE</span> untuk pencarian perkiraan, karena tabel referensi sudah diurutkan.
      </p>
      <div className="flex flex-col items-center mt-4 sm:mt-6">
        ...
        <div className="w-full overflow-x-auto">
          <table className="border-collapse border border-green-800 w-full text-center text-xs sm:text-sm md:text-base">
            <thead>
              <tr className="bg-[#255F38] text-white">
        ...
        <div className="w-full overflow-x-auto">
          <table className="border-collapse border border-green-800 w-full sm:w-3/4 md:w-1/3 text-center text-xs sm:text-sm md:text-base">
            <thead>
              <tr className="bg-[#255F38] text-white">
                <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Jumlah Pembelian (Rp ribu)</th>
                <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Kategori Diskon</th>
      ...
      <p className="text-gray-700 text-sm sm:text-base md:text-lg text-justify leading-relaxed px-4 mt-6">
        Penyelesaian dengan <span className="font-semibold italic">Computational Thinking:</span>
      </p>

      {/* DEKOMPOSISI VLOOKUP */}
      <div className="bg-white p-4 sm:p-5 border-gray-300 space-y-4 mt-8 sm:mt-12 relative">
        <div className="absolute -top-6 left-4 bg-green-800 text-white px-4 sm:px-5 py-2 rounded-t-lg text-base sm:text-lg font-bold flex items-center shadow-lg">
      ...
      {/* PENGENALAN POLA VLOOKUP */}
      <div className="bg-white p-4 sm:p-5 border-gray-300 space-y-4 mt-8 sm:mt-10 relative">
        <div className="absolute -top-6 left-4 bg-green-800 text-white px-4 sm:px-5 py-2 rounded-t-lg text-base sm:text-lg font-bold flex items-center shadow-lg">
      ...
      <div className="flex flex-col items-center mt-4 sm:mt-6">
        ...
        <div className="w-full overflow-x-auto">
          <table className="border-collapse border border-green-800 w-full sm:w-3/4 md:w-2/3 text-center text-xs sm:text-sm md:text-base">
            <thead>
              <tr className="bg-[#255F38] text-white">
      ...
      {/* Tombol Navigasi */}
      <div className="flex flex-col sm:flex-row justify-between mt-8 px-4 gap-4">
        <a
          href="/pencarian-lookup"
          className="bg-gray-500 text-white px-4 sm:px-5 py-2 rounded-lg hover:bg-gray-600 transition duration-300 text-sm sm:text-base shadow-md text-center"
        >
          ← Sebelumnya
        </a>
        <a
          href="/pencarian-reference"
          className="bg-green-800 text-white px-4 sm:px-5 py-2 rounded-lg hover:bg-green-700 transition duration-300 text-sm sm:text-base shadow-md text-center"
        >
          Selanjutnya →
        </a>
      </div>
