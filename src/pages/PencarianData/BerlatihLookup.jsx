    ...
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        <section className="p-6 bg-white rounded shadow-lg mb-6">
          ...
          <p className="px-4 text-sm leading-relaxed text-justify text-gray-700 md:text-base">
            SMP Bintang Jaya mengadakan lomba mewarnai untuk siswa kelas 8.
            Setiap siswa mendapatkan poin berdasarkan hasil karya mereka, dan
            poin ini digunakan untuk menentukan kategori prestasi (misalnya,
            Cukup, Baik, atau Sangat Baik). Selain itu, panitia memberikan
            hadiah berdasarkan urutan pemenang (peringkat). Kamu diminta
            membantu panitia untuk menentukan kategori prestasi dan hadiah
            menggunakan fungsi VLOOKUP dan CHOOSE.
          </p>
          <div className="w-full flex justify-center px-4 mt-5">
            <iframe
              width="800"
        ...
        <section className="mb-6">
          ...
          {[
            ...
            },
            {
              ...
              title: "2. Mencari Pola (Pengenalan Pola)",
              question:
                "Apa kategori prestasi siswa Budi dengan poin lomba 65?",
              points: [
                "Cari poin lomba Budi di Tabel 1.",
                "Cocokkan poin tersebut dengan poin minimal di Tabel 2.",
              ],
