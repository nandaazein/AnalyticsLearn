  ...
  useEffect(() => {
    const fetchKKM = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_API_ENDPOINT}/api/kkm/5`, {
      ...
      <div className="flex justify-center mt-8 space-x-4">
        {score >= kkm ? (
          ...
          <>
            ...
            <button
              onClick={() => navigate("/kuis-evaluasi")}
              className="px-5 py-2 text-base text-white transition duration-300 bg-red-600 rounded-lg shadow-md cursor-pointer hover:bg-red-700"
            >
              Ulang Evaluasi
            </button>
          </>
