...
export default function PeringkasanData() {
  ...
  // For brevity, I'm not repeating the state declarations, functions, and data arrays
  // (e.g., abstraksiAnswer, handleAbstraksiChange, sumifData, etc.) as they remain identical.
  // Assume all the state, functions, and data from your original code are included here.
  ...
  return (
    <Layout>
      ...
      <section className="bg-green-100 p-4 rounded shadow-md mt-6 mb-6">
        <h3 className="font-bold text-[#255F38] text-base sm:text-lg">Tujuan Pembelajaran:</h3>
        <ol className="list-decimal list-inside ml-4 sm:ml-6 space-y-2 mt-4 text-gray-700 responsive-text">
          <li>
            Peserta didik mampu merangkum data menggunakan fungsi peringkasan
          </li>
          <li>
      ...
      <ul className="list-disc list-inside mt-4 ml-4 sm:ml-6 text-gray-700 px-4 space-y-2 responsive-text">
        <li className="text-justify">
          <strong>Menghemat waktu</strong> dan tenaga → Dengan fungsi otomatis, kita tidak perlu menghitung satu per satu.
        </li>
        <li className="text-justify">
      ...
      <h3 className="font-bold text-[#255F38] mt-6 px-4 text-base sm:text-lg">
        Contoh Peringkasan Data dalam Kehidupan Sehari-hari
      </h3>
      <ul className="list-disc list-inside mt-4 ml-4 sm:ml-6 text-gray-700 px-4 space-y-2 responsive-text">
        <li className="text-justify">
      ...
      {/* Dekomposisi */}
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-12 relative">
        ...
        <ul className="list-disc list-inside ml-4 sm:ml-6 text-gray-700 space-y-2 responsive-text">
          <li className="text-justify">
            <strong>Tentukan apa</strong> yang ingin diringkas → Apakah ingin menjumlahkan angka (penjualan, nilai, dll.) atau menghitung jumlah data (jumlah siswa, jumlah transaksi, dll.)?
          </li>
          <li className="text-justify">
          ...
          <li className="text-justify">
            <strong>Pilih fungsi</strong> yang sesuai:
            <div className="ml-2 sm:ml-4 mt-2 space-y-4">
              <section className="bg-gray-100 p-3 sm:p-4 rounded shadow-lg">
                ...
                <p className="text-gray-700 mt-2 responsive-text">
                  <strong>SUMIF</strong> digunakan untuk menjumlahkan data dengan satu syarat.
                </p>
                <pre className="bg-gray-200 p-2 rounded text-gray-800 mt-2 text-xs sm:text-sm">
                  =SUMIF(range, criteria, sum_range)
                </pre>
                <p className="text-gray-700 mt-2 responsive-text">Keterangan:</p>
                <ul className="list-disc list-inside ml-4 sm:ml-6 text-gray-700 space-y-1 responsive-text">
                  <li><strong>range:</strong> Rentang data yang akan diperiksa kriterianya.</li>
                  <li><strong>criteria:</strong> Syarat yang harus dipenuhi agar nilainya dijumlahkan.</li>
                  <li><strong>sum_range:</strong> Rentang angka yang akan dijumlahkan jika kriterianya terpenuhi.</li>
                </ul>
        ...
        <div className="bg-[#F0FFF4] p-3 sm:p-4 border border-[#81C784] rounded mt-4 shadow-md">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg mb-2">
            AYO MENGELOMPOKKAN LANGKAH
          </h3>
          ...
          {/* Drop Zones */}
          <div className="mb-4">
            <h4 className="font-semibold text-green-700 mb-2 text-sm sm:text-base">Area Penempatan</h4>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 responsive-drop-zones">
              {["Menentukan Tujuan", "Menentukan Kriteria", "Memilih Fungsi"].map((category) => (
                <div
                  ...
                  onDrop={(e) => handleDrop(e, category)}
                  onDragOver={handleDragOver}
                  className="bg-white p-2 border-2 border-dashed border-green-400 rounded min-h-[100px] sm:min-h-[120px] flex flex-col items-center justify-center"
                >
                  <h4 className="font-semibold text-green-700 mb-2 text-sm sm:text-base">{category}</h4>
                  {categories[category].length > 0 ? (
                    categories[category].map((step) => (
                      <div
                        key={step.id}
          ...
          {/* Draggable Steps */}
          <div className="mb-2">
            <h4 className="font-semibold text-green-700 mb-2 text-sm sm:text-base">Langkah yang Bisa Digerakkan</h4>
            <div className="flex flex-wrap gap-2">
              {steps.map((step) => (
                <div
                  key={step.id}
                  draggable
                  onDragStart={(e) => handleDragStart(e, step.id)}
                  className="bg-white p-2 border border-gray-300 rounded cursor-move text-xs sm:text-sm responsive-draggable"
                >
                  {step.text}
                </div>
              ))}
          ...
          <div className="mt-4 flex space-x-2">
            <button
              onClick={checkAnswers}
              className="bg-[#1B5E20] text-white px-4 sm:px-5 py-2 rounded hover:bg-[#145A20] transition duration-300 cursor-pointer responsive-button"
            >
              Periksa
            </button>
            <button
              onClick={resetSteps}
              className="bg-[#D32F2F] text-white px-4 sm:px-5 py-2 rounded hover:bg-[#B71C1C] transition duration-300 cursor-pointer responsive-button"
            >
              Hapus
            </button>
          </div>
          ...
          {feedbackDrag && (
            <p
              className={`text-sm sm:text-base mt-2 font-bold ${
                feedbackDrag.includes("Benar") ? "text-green-700" : "text-red-700"
              }`}
            >
              {feedbackDrag}
      ...
      {/* Abstraksi */}
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-10 relative">
        <div className="absolute -top-6 left-4 bg-green-800 text-white px-3 sm:px-5 py-2 rounded-t-lg text-base sm:text-lg font-bold flex items-center shadow-lg">
        ...
        {/* Latihan Pemahaman Abstraksi */}
        <div className="bg-[#F0FFF4] p-3 sm:p-4 border border-[#81C784] rounded mt-4 shadow-md">
          <h3 className="font-semibold text-[#2E7D32] text-base sm:text-lg mb-2">
            Latihan Pemahaman: Memilih Data Penting
          </h3>
          <p className="text-gray-700 text-sm sm:text-base text-justify mb-2 responsive-text">
            Guru ingin menghitung jumlah siswa dengan nilai di atas 75 dari tabel yang berisi nama, kelas, dan nilai. Pilih data yang diperlukan:
          </p>
          <div className="ml-4 sm:ml-6 text-gray-700 space-y-2">
      ...
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        {/* Langkah-langkah Umum untuk SUMIF */}
        <div className="mt-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg mb-2">Langkah-langkah Menggunakan Fungsi SUMIF</h3>
          <ol className="list-decimal list-inside ml-4 sm:ml-6 text-gray-700 space-y-2 responsive-text">
            <li>Tentukan rentang data yang akan diperiksa untuk kriteria (range).</li>
            <li>Tentukan kriteria yang harus dipenuhi (misalnya, "8A" atau ">75").</li>
            <li>Tentukan rentang angka yang akan dijumlahkan (sum_range).</li>
            <li>Tulis rumus <code>=SUMIF(range, criteria, sum_range)</code> dengan benar.</li>
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 flex space-x-2">
            <button
              onClick={() => nextStep(sumifStep, setSumifStep, sumifSteps.length, setIsSumifStarted)}
              className="bg-[#255F38] text-white px-4 sm:px-4 py-2 rounded-lg hover:bg-[#1E4D2E] disabled:opacity-50 cursor-pointer responsive-button"
              disabled={sumifStep === sumifSteps.length - 1}
            >
              {isSumifStarted ? "Selanjutnya" : "Mulai"}
            </button>
            <button
              onClick={() => resetStep(setSumifStep, setIsSumifStarted)}
              className="bg-[#D32F2F] text-white px-4 sm:px-4 py-2 rounded-lg hover:bg-[#B71C1C] cursor-pointer responsive-button"
            >
              Ulangi
            </button>
          </div>
        ...
        {/* Langkah-langkah Umum untuk COUNTIF */}
        <div className="mt-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg mb-2">Langkah-langkah Menggunakan Fungsi COUNTIF</h3>
          <ol className="list-decimal list-inside ml-4 sm:ml-6 text-gray-700 space-y-2 responsive-text">
            <li>Tentukan rentang data yang akan diperiksa untuk kriteria (range).</li>
            <li>Tentukan kriteria yang harus dipenuhi (misalnya, ">75").</li>
            <li>Tulis rumus <code>=COUNTIF(range, criteria)</code> dengan benar.</li>
        ...
        {/* Langkah-langkah Umum untuk SUMIFS */}
        <div className="mt-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg mb-2">Langkah-langkah Menggunakan Fungsi SUMIFS</h3>
          <ol className="list-decimal list-inside ml-4 sm:ml-6 text-gray-700 space-y-2 responsive-text">
            <li>Tentukan rentang angka yang akan dijumlahkan (sum_range).</li>
            <li>Tentukan rentang data pertama yang akan diperiksa (criteria_range1) dan kriterianya (criteria1).</li>
            <li>Tentukan rentang data kedua yang akan diperiksa (criteria_range2) dan kriterianya (criteria2).</li>
        ...
        {/* Langkah-langkah Umum untuk COUNTIFS */}
        <div className="mt-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg mb-2">Langkah-langkah Menggunakan Fungsi COUNTIFS</h3>
          <ol className="list-decimal list-inside ml-4 sm:ml-6 text-gray-700 space-y-2 responsive-text">
            <li>Tentukan rentang data pertama yang akan diperiksa (criteria_range1) dan kriterianya (criteria1).</li>
            <li>Tentukan rentang data kedua yang akan diperiksa (criteria_range2) dan kriterianya (criteria2).</li>
            <li>Tulis rumus <code>=COUNTIFS(criteria_range1, criteria1, criteria_range2, criteria2)</code> dengan benar.</li>
      ...
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-12 relative">
        ...
        <div className="bg-yellow-50 p-3 sm:p-4 border border-yellow-300 rounded mt-4 shadow-md">
          <div className="mt-6">
            ...
            <div className="mt-4 flex justify-between items-center flex-col sm:flex-row gap-2 sm:gap-0">
              <div className="flex space-x-2">
                <button
                  onClick={goToPrevious}
                  className="bg-[#B0BEC5] text-white px-4 sm:px-4 py-2 rounded hover:bg-[#90A4AE] disabled:opacity-50 cursor-pointer responsive-button"
                  disabled={currentQuestion === 1}
                >
                  Sebelumnya
                </button>
                {isAnswered[currentQuestion] && (
                  <button
                    onClick={resetQuizAnswer}
                    className="bg-[#D32F2F] text-white px-4 sm:px-4 py-2 rounded hover:bg-[#B71C1C] cursor-pointer responsive-button"
                  >
                    Hapus
                  </button>
                )}
              ...
              {isAnswered[currentQuestion] && (
                <button
                  onClick={goToNext}
                  className="bg-yellow-800 text-white px-4 sm:px-4 py-2 rounded hover:bg-yellow-900 cursor-pointer responsive-button"
                >
                  {currentQuestion === 5 ? "Selesai" : "Soal Selanjutnya"}
                </button>
              )}
            ...
            {currentQuestion === 5 && isAnswered[currentQuestion] && (
              <p className="mt-4 text-center text-yellow-700 font-semibold text-sm sm:text-base">
                Anda telah menyelesaikan semua soal! Klik Selesai untuk meninjau!
              </p>
            )}
          </div>
      ...
      <div className="flex justify-between mt-8 px-4 responsive-nav-buttons">
        <button
          onClick={() => navigate("/feedback2")}
          className="bg-[#555757] text-white px-4 sm:px-5 py-2 rounded hover:bg-gray-600 transition duration-300 cursor-pointer responsive-button"
        >
          ← Sebelumnya
        </button>
        <button
          onClick={() => navigate("/penerapan-peringkasan")}
          className="bg-[#255F38] text-white px-4 sm:px-5 py-2 rounded hover:bg-[#1E4D2E] transition duration-300 cursor-pointer responsive-button"
        >
          Selanjutnya →
        </button>
      </div>
