...
export default function PeringkasanData() {
  ...
  const questions = [
    {
      question:
        "Fungsi yang digunakan untuk menjumlahkan data dengan satu syarat adalah....",
      options: ["A. SUMIF", "B. COUNTIF", "C. SUMIFS", "D. COUNTIFS"],
      correctAnswer: "A. SUMIF",
      explanation:
        "SUMIF menjumlahkan data berdasarkan satu kriteria tertentu.",
    },
    {
      question: "Fungsi COUNTIF dalam peringkasan data bertujuan untuk....",
      options: [
      ...
      correctAnswer: "B. Menghitung jumlah data dengan syarat",
      explanation:
        "COUNTIF menghitung jumlah data yang memenuhi satu kriteria.",
    },
    {
      question: "Fungsi SUMIFS berfungsi untuk....",
      options: [
    ...
    {
      question:
        "Langkah yang termasuk dalam dekomposisi peringkasan data adalah....",
      options: [
        "A. Menentukan kriteria peringkasan",
        "B. Menggambar grafik",
        "C. Menghitung rata-rata",
      ...
      correctAnswer: "A. Menentukan kriteria peringkasan",
      explanation:
        "Dekomposisi melibatkan menentukan kriteria untuk memecah masalah peringkasan data.",
    },
    {
      question: "Dalam proses abstraksi, yang harus dilakukan adalah....",
      options: [
      ...
      correctAnswer: "A. Mengabaikan data yang tidak relevan",
      explanation:
        "Abstraksi berfokus pada memilih data penting dan mengabaikan yang tidak diperlukan.",
    },
  ];
  ...
  const sumifSteps = [
    ...
    {
      description: "Cocokkan: Aisyah (8A) → Cocok.",
      highlightedRows: [0],
      result: null,
    },
    {
    ...
    {
      description: "Jumlahkan: 80 + 90 + 70 = 240.",
      highlightedRows: [0, 2, 3],
      result: 240,
    },
  ];
  ...
  const sumifsSteps = [
    {
      description: "Pilih sum range: Kolom 'Pendapatan' (C2:C6).",
      highlightedRows: [],
      result: null,
    },
    {
      description: "Criteria 1: 'Elektronik' di Kolom 'Kategori'.",
      highlightedRows: [],
      result: null,
    },
    {
      description: "Criteria 2: 'Januari' di Kolom 'Bulan'.",
      highlightedRows: [],
      result: null,
    },
    {
      description: "Laptop (Elektronik, Januari) → Cocok → 8.500.000.",
      highlightedRows: [0],
      result: null,
    },
    {
    ...
    {
      description: "Mouse (Elektronik, Januari) → Cocok → 150.000.",
      highlightedRows: [3],
      result: null,
    },
    {
    ...
    {
      description: "Jumlahkan: 8.500.000 + 150.000 = 8.650.000.",
      highlightedRows: [0, 3],
      result: 8650000,
    },
  ];
  ...
  const countifSteps = [
    {
      description: "Pilih range: Kolom 'Nilai Ujian' (B2:B6).",
      highlightedRows: [],
      result: null,
    },
  ...
  const countifsSteps = [
    {
      description: "Criteria 1: '8A' di Kolom 'Kelas'.",
      highlightedRows: [],
      result: null,
    },
    {
      description: "Criteria 2: '>75' di Kolom 'Nilai Ujian'.",
      highlightedRows: [],
      result: null,
    },
    {
      description: "Aisyah (8A, 80) → Cocok.",
      highlightedRows: [0],
      result: 1,
    },
    {
  ...
  const [steps, setSteps] = useState([
    {
      id: "step1",
      text: "Menghitung jumlah siswa lulus",
      category: "Menentukan Tujuan",
    },
    {
      id: "step2",
      text: "Memilih nilai di atas 75",
      category: "Menentukan Kriteria",
    },
    {
      id: "step3",
      text: "Menggunakan fungsi COUNTIF",
      category: "Memilih Fungsi",
    },
    {
      id: "step4",
      text: "Menjumlahkan total penjualan produk elektronik",
      category: "Menentukan Tujuan",
    },
    {
      id: "step5",
      text: "Memilih transaksi pada bulan Januari",
      category: "Menentukan Kriteria",
    },
  ]);
  ...
  return (
    <Layout>
      <div className="border-4 border-[#255F38] p-4 rounded-lg">
        ...
        <section className="bg-green-100 p-4 rounded shadow-md mt-6 mb-6">
          ...
          <ol className="list-decimal list-inside ml-6 space-y-2 mt-4 text-gray-700">
            ...
            <li>
              ...
              dalam menyelesaikan permasalahan yang berkaitan dengan peringkasan
              data.
            </li>
          </ol>
        </section>
        ...
        <ul className="list-disc list-inside mt-4 ml-6 text-gray-700 px-4 space-y-2">
          <li className="text-justify">
            <strong>Menghemat waktu</strong> dan tenaga → Dengan fungsi
            otomatis, kita tidak perlu menghitung satu per satu.
          </li>
          <li className="text-justify">
            <strong>Membantu dalam</strong> pengambilan keputusan → Data yang
            telah diringkas lebih mudah dianalisis.
          </li>
          <li className="text-justify">
            <strong>Menampilkan informasi</strong> lebih jelas → Menghindari
            tumpukan angka yang sulit dipahami.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside mt-4 ml-6 text-gray-700 px-4 space-y-2">
          <li className="text-justify">
            <strong>Seorang siswa</strong> ingin tahu berapa kali ia membeli
            makanan favorit di kantin dalam satu minggu → Dengan COUNTIF, ia
            bisa langsung mendapatkan jumlahnya.
          </li>
          <li className="text-justify">
            <strong>Seseorang mencatat</strong> pengeluarannya setiap bulan dan
            ingin tahu total pengeluaran untuk transportasi → Dengan SUMIF, ia
            bisa menjumlahkan hanya untuk kategori transportasi.
          </li>
          <li className="text-justify">
            <strong>Seorang guru</strong> ingin tahu berapa siswa yang mendapat
            nilai di atas 75 → Dengan COUNTIF, ia bisa langsung mengetahui
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
          ...
          <p className="text-gray-700 text-sm md:text-base mt-4 text-justify">
            ...
            langkah-langkah kecil yang lebih mudah dikelola. Dalam peringkasan
            data, kita memecah proses menjadi tiga kategori utama:
          </p>
          <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
            <li className="text-justify">
              <strong>Tentukan apa</strong> yang ingin diringkas → Apakah ingin
              menjumlahkan angka (penjualan, nilai, dll.) atau menghitung jumlah
              data (jumlah siswa, jumlah transaksi, dll.)?
            </li>
            <li className="text-justify">
              <strong>Tentukan kriteria</strong> peringkasan → Misalnya, hanya
              menjumlahkan nilai siswa yang lebih dari 75 atau hanya menghitung
            ...
            <li className="text-justify">
              ...
              <div className="ml-4 mt-2 space-y-4">
                <section className="bg-gray-100 p-4 rounded shadow-lg">
                  <h3 className="font-semibold text-[#255F38] mb-2">
                    1. SUMIF
                  </h3>
                  <p className="text-gray-700 mt-2">
                    <strong>SUMIF</strong> digunakan untuk menjumlahkan data
                    dengan satu syarat.
                  </p>
                  <pre className="bg-gray-200 p-2 rounded text-gray-800 mt-2">
                    =SUMIF(range, criteria, sum_range)
                  ...
                  <ul className="list-disc list-inside ml-6 text-gray-700 space-y-1">
                    ...
                    <li>
                      <strong>sum_range:</strong> Rentang angka yang akan
                      dijumlahkan jika kriterianya terpenuhi.
                    </li>
                  </ul>
                </section>
                ...
                <section className="bg-gray-100 p-4 rounded shadow-lg">
                  ...
                  <p className="text-gray-700 mt-2">
                    <strong>SUMIFS</strong> digunakan untuk menjumlahkan data
                    dengan lebih dari satu syarat.
                  </p>
                  <pre className="bg-gray-200 p-2 rounded text-gray-800 mt-2">
                  ...
                  <ul className="list-disc list-inside ml-6 text-gray-700 space-y-1">
                    <li>
                      <strong>sum_range:</strong> Rentang data yang akan
                      dijumlahkan.
                    </li>
                    <li>
                      <strong>criteria_range1:</strong> Rentang pertama yang
                      akan diperiksa.
                    </li>
                    <li>
                      <strong>criteria1:</strong> Syarat pertama yang harus
                      dipenuhi.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>criteria2:</strong> Syarat kedua yang harus
                      dipenuhi.
                    </li>
                  </ul>
                </section>
                ...
                <section className="bg-gray-100 p-4 rounded shadow-lg">
                  ...
                  <p className="text-gray-700 mt-2">
                    <strong>COUNTIF</strong> digunakan untuk menghitung jumlah
                    data dengan satu syarat.
                  </p>
                  <pre className="bg-gray-200 p-2 rounded text-gray-800 mt-2">
                    =COUNTIF(range, criteria)
                  </pre>
                  ...
                  <ul className="list-disc list-inside ml-6 text-gray-700 space-y-1">
                    ...
                    <li>
                      <strong>criteria:</strong> Kriteria yang harus dipenuhi
                      agar data dihitung.
                    </li>
                  </ul>
                </section>
                ...
                <section className="bg-gray-100 p-4 rounded shadow-lg">
                  ...
                  <p className="text-gray-700 mt-2">
                    <strong>COUNTIFS</strong> digunakan untuk menghitung jumlah
                    data dengan lebih dari satu syarat.
                  </p>
                  <pre className="bg-gray-200 p-2 rounded text-gray-800 mt-2">
          ...
          <div className="bg-[#F5F5F5] p-2 sm:p-3 md:p-4 border border-[#B0BEC5] rounded mt-4 sm:mt-6 shadow-md">
            ...
            <p className="text-gray-700 text-xs sm:text-sm md:text-base text-justify mb-2">
              Perhatikan beberapa langkah yang biasa dilakukan saat meringkas
              data. Setiap langkah memiliki <strong>tujuan</strong>,{" "}
              <strong>kriteria</strong>, atau <strong>fungsi</strong> tertentu
              dalam proses peringkasan.
            </p>
            <p className="text-gray-700 text-xs sm:text-sm md:text-base text-justify mb-2">
              Seret masing-masing langkah ke dalam kotak yang paling sesuai:{" "}
              <strong>Tujuan</strong>, <strong>Kriteria</strong>, atau{" "}
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
          ...
          <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
            <li className="text-justify">
              <strong>Menjumlahkan total</strong> penjualan berdasarkan kategori
              produk → Dengan SUMIF, kita bisa menjumlahkan total penjualan
              hanya untuk kategori tertentu.
            </li>
            <li className="text-justify">
              <strong>Menghitung jumlah</strong> siswa yang mendapat nilai di
              atas batas tertentu → Dengan COUNTIF, kita bisa menghitung berapa
              banyak siswa yang mendapat nilai lebih dari 75.
            </li>
            <li className="text-justify">
              <strong>Menjumlahkan total</strong> penjualan dengan beberapa
              syarat → Dengan SUMIFS, kita bisa menjumlahkan hanya transaksi
              yang memenuhi lebih dari satu kriteria, misalnya kategori produk
              tertentu dan periode tertentu.
            </li>
            <li className="text-justify">
              <strong>Menghitung jumlah</strong> data berdasarkan lebih dari
              satu kriteria → Dengan COUNTIFS, kita bisa menghitung berapa
              transaksi yang terjadi di bulan tertentu untuk produk tertentu.
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
          ...
          <p className="text-gray-700 text-sm md:text-base mt-4 text-justify">
            Agar lebih mudah dipahami, kita hanya fokus pada bagian penting
            dalam data dan mengabaikan informasi yang tidak diperlukan.
          </p>
          <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
            <li className="text-justify">
              <strong>Hanya pilih</strong> data yang benar-benar diperlukan →
              Jika ingin menghitung jumlah siswa yang lulus, kita hanya perlu
              kolom "Nilai Ujian", tidak perlu melihat nama siswa.
            </li>
            <li className="text-justify">
              <strong>Gunakan rumus</strong> yang tepat → Jika hanya butuh
              jumlah siswa yang lulus, cukup gunakan COUNTIF tanpa perlu SUMIF.
            </li>
          </ul>
          {/* Latihan Pemahaman Abstraksi */}
          <div className="bg-[#F5F5F5] p-2 sm:p-3 md:p-4 border border-[#B0BEC5] rounded mt-4 sm:mt-6 shadow-md">
            ...
            <p className="text-gray-700 text-xs sm:text-sm md:text-base text-justify mb-2">
              Guru ingin menghitung jumlah siswa dengan nilai di atas 75 dari
              tabel yang berisi nama, kelas, dan nilai. Pilih data yang
              diperlukan:
            </p>
            <div className="ml-6 text-gray-700 space-y-2">
              <div className="text-xs sm:text-sm md:text-base">
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
          ...
          <p className="text-gray-600 text-sm md:text-base mt-4 text-justify">
            Setelah kita memahami data dan menyederhanakannya, kita bisa membuat
            langkah-langkah sistematis untuk menerapkan peringkasan data dalam
            spreadsheet. Berikut adalah langkah-langkah umum untuk menggunakan
            fungsi-fungsi peringkasan data:
          </p>

          {/* Langkah-langkah Umum untuk SUMIF */}
          <div className="mt-6">
            <h3 className="font-semibold text-[#255F38] text-lg mb-2">
              Langkah-langkah Menggunakan Fungsi SUMIF
            </h3>
            <ol className="list-decimal list-inside ml-6 text-gray-700 space-y-2">
              <li>
                Tentukan rentang data yang akan diperiksa untuk kriteria
                (range).
              </li>
              <li>
                Tentukan kriteria yang harus dipenuhi (misalnya, "8A" atau
                ">75").
              </li>
              <li>Tentukan rentang angka yang akan dijumlahkan (sum_range).</li>
              <li>
                Tulis rumus <code>=SUMIF(range, criteria, sum_range)</code>{" "}
                dengan benar.
              </li>
            </ol>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 text-base mb-4">
              Klik tombol untuk melihat langkah-langkah kerja fungsi SUMIF dalam
              menjumlahkan nilai siswa kelas 8A.
            </p>
            <div className="flex flex-col items-center mt-4">
              <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
                <thead>
            ...
            <div className="mt-4">
              <p className="text-gray-700 text-base">
                <strong>Langkah {sumifStep + 1}:</strong>{" "}
                {sumifSteps[sumifStep]?.description || "Langkah tidak tersedia"}
              </p>
              {sumifSteps[sumifStep]?.result !== null && (
                <p className="text-gray-700 text-base mt-2">
                  <strong>Hasil:</strong> {sumifSteps[sumifStep].result}
          ...
          <div className="mt-6">
            <h3 className="font-semibold text-[#255F38] text-lg mb-2">
              Langkah-langkah Menggunakan Fungsi COUNTIF
            </h3>
            <ol className="list-decimal list-inside ml-6 text-gray-700 space-y-2">
              <li>
                Tentukan rentang data yang akan diperiksa untuk kriteria
              ...
              <li>Tentukan kriteria yang harus dipenuhi (misalnya, ">75").</li>
              <li>
                Tulis rumus <code>=COUNTIF(range, criteria)</code> dengan benar.
              </li>
            </ol>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 text-base mb-4">
              Klik tombol untuk melihat langkah-langkah kerja fungsi COUNTIF
              dalam menghitung jumlah siswa dengan nilai di atas 75.
            </p>
            <div className="flex flex-col items-center mt-4">
              <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
                <thead>
                ...
                <tbody>
                  {countifData.map((item, index) => (
                    <tr
                      key={index}
                      className={
                        countifSteps[countifStep]?.highlightedRows?.includes(
                          index
                        )
                          ? "bg-yellow-200"
                          : index % 2 === 0
            ...
            <div className="mt-4">
              <p className="text-gray-700 text-base">
                <strong>Langkah {countifStep + 1}:</strong>{" "}
                {countifSteps[countifStep]?.description ||
                  "Langkah tidak tersedia"}
              </p>
              {countifSteps[countifStep]?.result !== null && (
                <p className="text-gray-700 text-base mt-2">
                  <strong>Hasil Sementara:</strong>{" "}
                  {countifSteps[countifStep].result}
                </p>
              )}
            </div>
            <div className="mt-4 flex space-x-2">
          ...
          <div className="mt-6">
            <h3 className="font-semibold text-[#255F38] text-lg mb-2">
              Langkah-langkah Menggunakan Fungsi SUMIFS
            </h3>
            <ol className="list-decimal list-inside ml-6 text-gray-700 space-y-2">
              <li>Tentukan rentang angka yang akan dijumlahkan (sum_range).</li>
              <li>
                Tentukan rentang data pertama yang akan diperiksa
                (criteria_range1) dan kriterianya (criteria1).
              </li>
              <li>
                Tentukan rentang data kedua yang akan diperiksa
                (criteria_range2) dan kriterianya (criteria2).
              </li>
              <li>
                Tulis rumus{" "}
                <code>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 text-base mb-4">
              Klik tombol untuk melihat langkah-langkah kerja fungsi SUMIFS
              dalam menjumlahkan pendapatan kategori Elektronik pada bulan
              Januari.
            </p>
            <div className="flex flex-col items-center mt-4">
              <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
                ...
                <tbody>
                  {sumifsData.map((item, index) => (
                    <tr
                      key={index}
                      className={
                        sumifsSteps[sumifsStep]?.highlightedRows?.includes(
                          index
                        )
                          ? "bg-yellow-200"
                          : index % 2 === 0
            ...
            <div className="mt-4">
              <p className="text-gray-700 text-base">
                <strong>Langkah {sumifsStep + 1}:</strong>{" "}
                {sumifsSteps[sumifsStep]?.description ||
                  "Langkah tidak tersedia"}
              </p>
              {sumifsSteps[sumifsStep]?.result !== null && (
                <p className="text-gray-700 text-base mt-2">
                  <strong>Hasil:</strong>{" "}
                  {sumifsSteps[sumifsStep].result.toLocaleString()}
                </p>
              )}
            </div>
            <div className="mt-4 flex space-x-2">
          ...
          <div className="mt-6">
            <h3 className="font-semibold text-[#255F38] text-lg mb-2">
              Langkah-langkah Menggunakan Fungsi COUNTIFS
            </h3>
            <ol className="list-decimal list-inside ml-6 text-gray-700 space-y-2">
              <li>
                Tentukan rentang data pertama yang akan diperiksa
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 text-base mb-4">
              Klik tombol untuk melihat langkah-langkah kerja fungsi COUNTIFS
              dalam menghitung jumlah siswa kelas 8A dengan nilai di atas 75.
            </p>
            <div className="flex flex-col items-center mt-4">
              <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
                <thead>
                ...
                <tbody>
                  {countifsData.map((item, index) => (
                    <tr
                      key={index}
                      className={
                        countifsSteps[countifsStep]?.highlightedRows?.includes(
                          index
                        )
                          ? "bg-yellow-200"
                          : index % 2 === 0
            ...
            <div className="mt-4">
              <p className="text-gray-700 text-base">
                <strong>Langkah {countifsStep + 1}:</strong>{" "}
                {countifsSteps[countifsStep]?.description ||
                  "Langkah tidak tersedia"}
              </p>
              {countifsSteps[countifsStep]?.result !== null && (
                <p className="text-gray-700 text-base mt-2">
                  <strong>Hasil Sementara:</strong>{" "}
                  {countifsSteps[countifsStep].result}
                </p>
              )}
            </div>
            <div className="mt-4 flex space-x-2">
              <button
                onClick={() =>
                  nextStep(
                    countifsStep,
                    setCountifsStep,
                    countifsSteps.length,
                    setIsCountifsStarted
                  )
                }
                className="bg-[#255F38] text-white px-4 py-2 rounded-lg hover:bg-[#1E4D2E] disabled:opacity-50 cursor-pointer"
                disabled={countifsStep === countifsSteps.length - 1}
        ...
        <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
          ...
          <p className="text-gray-700 text-xs sm:text-sm md:text-base text-justify">
            Jawab pertanyaan berikut untuk menguji pemahamanmu tentang fungsi
            peringkasan data:
          </p>
          <div className="bg-yellow-50 p-2 sm:p-3 md:p-4 border border-yellow-300 rounded mt-4 shadow-md">
            <div className="mt-6">
              ...
              {currentQuestion === 5 && isAnswered[currentQuestion] && (
                <p className="mt-4 text-center text-yellow-700 font-semibold text-xs sm:text-sm md:text-base">
                  Anda telah menyelesaikan semua soal! Klik Selesai untuk
                  meninjau!
                </p>
              )}
            </div>
