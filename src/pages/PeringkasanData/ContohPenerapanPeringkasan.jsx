  ...
  return (
    <Layout>
        ...
        <table className="border-collapse border border-green-800 w-full text-center responsive-table">
          ...
          <tbody>
            {[
              ...
              <tr key={index} className={index % 2 === 0 ? "bg-green-50" : "bg-white"}>
                {row.map((cell, i) => (
                  <td key={i} className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">
                    {i === 2 ? new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(cell) : cell}
                  </td>
                ))}
              </tr>
      ...
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-12 relative responsive-section">
        ...
        <ul className="text-gray-700 list-disc pl-4 sm:pl-6 ml-4 sm:ml-6 space-y-1 mt-6 responsive-text">
          <li>Tentukan tujuan: Menjumlahkan iuran "Kebersihan" (SUMIF) dan pengeluaran "Alat Kebersihan" di "Maret" (SUMIFS).</li>
          <li>Tentukan kriteria: "Kebersihan" untuk SUMIF, "Alat Kebersihan" dan "Maret" untuk SUMIFS.</li>
          <li>Data: Tabel dengan kolom Kategori, Bulan, dan Jumlah.</li>
        </ul>
      ...
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-10 relative responsive-section">
        ...
        <p className="text-gray-700 font-semibold mt-6 responsive-text">Contoh Penerapan SUMIF:</p>
        <ul className="text-gray-700 list-disc pl-4 sm:pl-6 ml-4 sm:ml-6 space-y-1 mt-2 responsive-text">
          <li>Pilih range "Kategori" (A2:A8), kriteria "Kebersihan".</li>
          <li>Pilih sum_range "Jumlah" (C2:C8).</li>
          <li>Rumus: <code className="bg-gray-200 px-2 py-1 rounded">=SUMIF(A2:A8;"Kebersihan";C2:C8)</code></li>
          <li>Hasil: Total iuran "Kebersihan" adalah Rp10.000.</li>
        </ul>
        <p className="text-gray-700 font-semibold mt-4 responsive-text">Contoh Penerapan SUMIFS:</p>
        <ul className="text-gray-700 list-disc pl-4 sm:pl-6 ml-4 sm:ml-6 space-y-1 mt-2 responsive-text">
          <li>Pilih sum_range "Jumlah" (C2:C8).</li>
          <li>Kriteria 1: "Kategori" (A2:A8) = "Alat Kebersihan".</li>
          <li>Kriteria 2: "Bulan" (B2:B8) = "Maret".</li>
      ...
      {/* Studi Kasus 2: COUNTIF & COUNTIFS */}
      <h2 className="text-base sm:text-lg md:text-xl font-bold mt-12 mb-4 px-4 text-gray-800">
        Studi Kasus 2: Menghitung dengan COUNTIF & COUNTIFS
      </h2>
      <p className="text-gray-700 text-sm sm:text-base text-justify leading-relaxed px-4 responsive-text">
        Sebagai guru, kamu mencatat partisipasi siswa dalam kegiatan ekstrakurikuler. Gunakan <span className="font-semibold">COUNTIF</span> untuk menghitung jumlah kegiatan "Olahraga". Gunakan <span className="font-semibold">COUNTIFS</span> untuk menghitung siswa perempuan kelas 8A yang berpartisipasi.
      ...
      <div className="flex flex-col items-center mt-4 responsive-table-container">
        ...
        <table className="border-collapse border border-green-800 w-full text-center responsive-table">
          <thead>
            <tr className="bg-[#255F38] text-white">
              <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Jenis Kegiatan</th>
              <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Kelas</th>
              <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Jenis Kelamin</th>
              <th className="border border-green-600 px-2 sm:px-4 py-1 sm:py-2">Partisipasi</th>
            </tr>
          </thead>
          <tbody>
            {[
      ...
      <div className="bg-white p-3 sm:p-5 border-gray-300 space-y-4 mt-10 relative responsive-section">
        ...
        <p className="text-gray-700 font-semibold mt-6 responsive-text">Contoh Penerapan COUNTIF:</p>
        <ul className="text-gray-700 list-disc pl-4 sm:pl-6 ml-4 sm:ml-6 space-y-1 mt-2 responsive-text">
          <li>Pilih range "Jenis Kegiatan" (A2:A7), kriteria "Olahraga".</li>
          <li>Rumus: <code className="bg-gray-200 px-2 py-1 rounded">=COUNTIF(A2:A7;"Olahraga")</code></li>
          <li>Hasil: Jumlah kegiatan "Olahraga" adalah 3.</li>
        </ul>
        <p className="text-gray-700 font-semibold mt-4 responsive-text">Contoh Penerapan COUNTIFS:</p>
        <ul className="text-gray-700 list-disc pl-4 sm:pl-6 ml-4 sm:ml-6 space-y-1 mt-2 responsive-text">
          <li>Kriteria 1: "Kelas" (B2:B7) = "8A".</li>
          <li>Kriteria 2: "Jenis Kelamin" (C2:C7) = "Perempuan".</li>
          <li>Kriteria 3: "Partisipasi" (D2:D7) = "Ya".</li>
