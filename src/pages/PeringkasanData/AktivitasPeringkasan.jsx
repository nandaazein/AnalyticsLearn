...
//               feedback1.startsWith("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
//             }`}>
//               {feedback1}
//             </p>
//           )}
...
//           {feedback2 && (
//             <p className={`text-xs font-bold sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg ${
//               feedback2.startsWith("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
//             }`}>
//               {feedback2}
//             </p>
//           )}
...
//             {feedback3 && (
//               <p className={`text-xs font-bold sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg ${
//                 feedback3.startsWith("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
//               }`}>
//                 {feedback3}
//               </p>
//             )}
...
//             <div className="mb-2 sm:mb-4">{renderDraggableItems(bank4, urutan4)}</div>
//             <div
...
//             {feedback4 && (
//               <p className={`text-xs font-bold sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg ${
//                 feedback4.startsWith("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
//               }`}>
//                 {feedback4}
//               </p>
//             )}
...
//           </p>
//           <div className="px-2 sm:px-4">
//             <div className="mb-2 sm:mb-4">{renderDraggableItems(bank5, urutan5)}</div>
//             <div
//               className="border border-gray-400 p-2 sm:p-4 rounded mb-2 sm:mb-4 min-h-[150px] bg-gray-50"
//               onDrop={(e) => handleDrop(e, setUrutan5)}
//               onDragOver={allowDrop}
...
//             {feedback5 && (
//               <p className={`text-xs font-bold sm:text-sm md:text-base mt-2 px-3 py-2 rounded-lg ${
//                 feedback5.startsWith("Benar") ? "bg-[#C8E6C9] text-[#1B5E20]" : "bg-[#FFEBEE] text-[#D32F2F]"
//               }`}>
//                 {feedback5}
//               </p>
//             )}
