      ...
      <div className="flex items-start justify-center flex-1 p-4 sm:p-6 bg-gray-100 min-h-screen">
        <div className="w-full max-w-4xl p-4 sm:p-8 bg-white rounded-lg shadow-lg">
          ...
          <div className="flex justify-center gap-4 mt-4 sm:mt-6">
            <button
              onClick={() => (window.location.href = "/kuis-visualisasi")}
              className="bg-[#255f38] text-white px-4 sm:px-5 py-2 rounded-lg hover:bg-[#1E4D2E] cursor-pointer transition duration-300 text-sm sm:text-base"
            >
              Mulai
            </button>
          </div>
          ...
          {/* History Table for Kuis 2 */}
          <div className="max-w-4xl mx-auto mt-6 sm:mt-8 bg-white rounded-md shadow-md">
            <div className="px-4 py-2 border-b border-gray-300">
            ...
            {error && (
              <p className="px-4 py-2 text-xs sm:text-sm text-red-500">{error}</p>
            )}
            {isLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-gray-900">
                  <thead>
                    <tr className="border-b border-gray-300">
                      <th className="px-4 py-2 sm:py-3 font-semibold text-xs sm:text-sm">
                        Tanggal
                      </th>
                      <th className="px-4 py-2 sm:py-3 font-semibold text-xs sm:text-sm text-center">
                        Persentase
                      </th>
                      <th className="px-4 py-2 sm:py-3 font-semibold text-xs sm:text-sm">
                        Status
                  ...
                  <tbody>
                    {history.map((attempt, index) => (
                      <tr key={index} className="border-b border-gray-200">
                        <td className="px-4 py-2 sm:py-3 text-xs sm:text-sm">
                          {new Date(attempt.date).toLocaleString("id-ID", {
                            day: "2-digit",
                            month: "long",
                            year: "numeric",
                        ...
                        <td className="px-4 py-2 sm:py-3 text-xs sm:text-sm text-center">
                          {attempt.percentage}
                        </td>
                        <td className="px-4 py-2 sm:py-3 text-xs sm:text-sm">
                          <span
