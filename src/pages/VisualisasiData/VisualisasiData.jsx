...
export default function VisualisasiData() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-6 sm:mt-8 md:mt-10 relative">
        <div className="absolute -top-3 sm:-top-4 md:-top-6 left-2 sm:left-4 bg-green-800 text-white px-2 sm:px-3 md:px-5 py-1 rounded-t-lg text-base sm:text-lg font-bold shadow-lg">
          PERAN VISUALISASI DATA
        </div>
      ...
      <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12 relative text-justify">
        <div className="absolute -top-3 sm:-top-4 md:-top-6 left-2 sm:left-4 bg-green-800 text-white px-2 sm:px-3 md:px-5 py-1 rounded-t-lg text-base sm:text-lg font-bold shadow-lg">
          CONTOH DALAM KEHIDUPAN SEHARI-HARI
        </div>
      ...
      <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12 relative text-justify">
        ...
        <div className="bg-[#F5F5F5] p-2 sm:p-3 md:p-4 border border-[#B0BEC5] rounded mt-4 sm:mt-6 shadow-md">
          ...
          <p className="text-gray-700 text-xs sm:text-sm md:text-base mb-2">
            Kamu ingin menunjukkan perubahan kehadiran siswa selama satu semester. Pilih jenis chart yang paling sesuai:
          </p>
          <div className="ml-4 sm:ml-6 text-gray-700 space-y-1 sm:space-y-2">
            <div className="text-xs sm:text-sm md:text-base">
              <label className="flex items-center">
      ...
      <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12 relative">
        <div className="absolute -top-3 sm:-top-4 md:-top-6 left-2 sm:left-4 bg-green-800 text-white px-2 sm:px-3 md:px-5 py-1 rounded-t-lg text-base sm:text-lg font-bold shadow-lg">
          ABSTRAKSI
        </div>
        <p className="text-gray-700 text-xs sm:text-sm md:text-base mt-4 sm:mt-6">
      ...
      <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12">
        <div className="flex items-center justify-between px-2 py-2 bg-gray-100 border-b border-gray-300 rounded-t-lg sm:px-4 md:px-6">
          <h3 className="font-semibold text-[#255F38] text-base sm:text-lg">Kuis Pemahaman: Visualisasi Data</h3>
