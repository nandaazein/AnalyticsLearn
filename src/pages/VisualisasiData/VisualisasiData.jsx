  ...
  return (
    <Layout>
      <div className="border-l-4 border-[#255F38] pl-4">
        ...
        <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-6 sm:mt-8 md:mt-10 relative border border-gray-300">
        ...
        <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12 relative text-justify border border-gray-300">
          <div className="absolute -top-3 sm:-top-4 md:-top-6 left-2 sm:left-4 bg-green-800 text-white px-2 sm:px-3 md:px-5 py-1 rounded-t-lg text-base sm:text-lg font-bold shadow-lg">
        ...
        <div className="bg-white p-2 sm:p-3 md:p-5 border-gray-300 space-y-2 sm:space-y-4 mt-8 sm:mt-10 md:mt-12 relative border border-gray-300">
          <div className="absolute -top-3 sm:-top-4 md:-top-6 left-2 sm:left-4 bg-green-800 text-white px-2 sm:px-3 md:px-5 py-1 rounded-t-lg text-base sm:text-lg font-bold shadow-lg">
            ABSTRAKSI
          </div>
          <p className="text-gray-700 text-xs sm:text-sm md:text-base mt-4 sm:mt-6">
